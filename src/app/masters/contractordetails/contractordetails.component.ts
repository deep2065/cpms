...
@Component({
  selector: '[contractordetails]',
  templateUrl: './contractordetails.template.html',
  styleUrls: [ './contractordetails.style.scss' ],
...
db.list('/contractors').subscribe(keys=>keys.forEach(ele=>{
  if(ele.$key==key){
